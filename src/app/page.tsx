  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden min-h-[600px] sm:min-h-[720px] flex items-center">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#1E1E2E]/85 via-[#1E1E2E]/60 to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#1E1E2E]/40 via-transparent to-[#1E1E2E]/20" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 w-full">
          <div className="max-w-2xl animate-fade-in-up">
            ...
            <p className="mt-6 text-lg sm:text-xl text-white/85 leading-relaxed max-w-lg">
            ...
            <p className="mt-6 text-sm text-white/45 font-medium">
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            {/* Content */}
            <div className="order-1 lg:order-2 animate-fade-in-up-delay-1">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-extrabold text-text leading-[1.15] mb-6">
      ...
      <section className="bg-periwinkle-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in-up">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[2.75rem] font-extrabold text-text leading-[1.15] mb-5">
          ...
          {/* Ethics pledge */}
          <div className="mt-16 bg-white rounded-2xl section-shadow p-8 sm:p-10 max-w-3xl mx-auto animate-fade-in-up">
            <div className="text-center">
              <h3 className="text-xl font-extrabold text-text mb-2">The Flor Ethics Pledge</h3>
              <p className="text-sm text-text-light mb-6">Every job on Flor meets these standards. No&nbsp;exceptions.</p>
            </div>
              ...
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  <div className="w-6 h-6 rounded-full bg-success-light flex items-center justify-center flex-shrink-0">
                    <svg className="w-3.5 h-3.5 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            {/* Photo with floating score */}
            <div className="relative animate-fade-in-up">
              <div className="relative rounded-3xl overflow-hidden hero-shadow aspect-[3/4] max-h-[560px]">
                <Image
              ...
              {/* Floating Fit Score card */}
              <div className="absolute -bottom-6 -right-2 sm:bottom-8 sm:-right-6 bg-white rounded-2xl section-shadow p-5 w-56 sm:w-60 animate-float">
                <div className="flex items-center gap-3 mb-4">
                  <div className="relative w-16 h-16 flex-shrink-0">
                    <svg className="w-16 h-16 -rotate-90" viewBox="0 0 64 64">
                      <circle cx="32" cy="32" r="28" fill="none" stroke="#E4E5F4" strokeWidth="4" />
                      <circle cx="32" cy="32" r="28" fill="none" stroke="#8B8FD4" strokeWidth="4" strokeDasharray="153 23" strokeLinecap="round" />
                    </svg>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <span className="text-xl font-extrabold text-periwinkle">87</span>
                    </div>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-periwinkle uppercase tracking-wider">Flor Fit</div>
      ...
      <section className="bg-offwhite">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="text-center max-w-2xl mx-auto mb-14 animate-fade-in-up">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-text leading-[1.15] mb-4">
            ...
            {[
              ...
              >
                ...
                <div className="p-6 sm:p-8">
                  <svg className="w-8 h-8 text-periwinkle-200 mb-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M4.583 17.321C3.553 16.227 3 15 3 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179zm10 0C13.553 16.227 13 15 13 13.011c0-3.5 2.457-6.637 6.03-8.188l.893 1.378c-3.335 1.804-3.987 4.145-4.247 5.621.537-.278 1.24-.375 1.929-.311 1.804.167 3.226 1.648 3.226 3.489a3.5 3.5 0 01-3.5 3.5c-1.073 0-2.099-.49-2.748-1.179z" />
                  </svg>
                  <blockquote className="text-base sm:text-lg font-medium text-text leading-relaxed mb-4">
                    {item.quote}
                  </blockquote>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <Link
                href="/jobs"
                className="inline-flex items-center gap-2 text-periwinkle hover:text-periwinkle-dark font-bold text-sm transition-colors"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Visual badges show exactly what shifts and hours — no surprises in fine print.",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
              ...
              },
              {
                ...
                desc: "Apply straight to facilities. No recruiters taking a cut of your pay.",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
                  </svg>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-10 sm:mb-14">
            <div>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-text">Featured Jobs</h2>
              <p className="text-text-light mt-2 text-base leading-relaxed">Real jobs with real pay, ready for you right now.</p>
            </div>
            <Link
              href="/jobs"
              className="inline-flex items-center gap-2 text-periwinkle hover:text-periwinkle-dark font-bold text-sm transition-colors flex-shrink-0"
            >
              View all jobs
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
      ...
      <section className="bg-offwhite">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="relative bg-gradient-to-br from-[#1E1E2E] via-[#2A2A3C] to-[#1E1E2E] rounded-3xl p-10 sm:p-16 text-center text-white overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-periwinkle/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-periwinkle/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-periwinkle/5 rounded-full blur-3xl" />
            ...
            <div className="relative">
              ...
              <p className="text-lg sm:text-xl text-white/75 mb-10 max-w-lg mx-auto leading-relaxed">
