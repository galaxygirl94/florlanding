...
export default function JobListingsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <button
        className="md:hidden w-full mb-5 bg-white border border-periwinkle-100 rounded-2xl px-4 py-3.5 text-sm font-semibold text-periwinkle flex items-center justify-center gap-2 min-h-[44px] section-shadow"
        ...
        <div className="flex gap-2">
          {SPECIALTIES.map((s) => (
            <button
              ...
              className={`whitespace-nowrap px-3.5 py-2 rounded-xl text-sm font-medium transition-all duration-200 min-h-[44px] ${
                specialty === s
                  ? "bg-periwinkle text-white shadow-sm shadow-periwinkle/20"
                  : "bg-white text-text-light border border-periwinkle-100 hover:border-periwinkle-200"
              }`}
            >
      ...
      {/* Filters panel */}
      <div className={`${showFilters ? "block" : "hidden"} md:block bg-white rounded-2xl section-shadow p-5 sm:p-6 mb-6 sm:mb-8`}>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full border border-periwinkle-100 rounded-xl px-3 py-3 text-sm bg-white min-h-[44px] transition-all duration-200"
            >
              {SPECIALTIES.map((s) => (
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-periwinkle-100 rounded-xl px-3 py-3 text-sm min-h-[44px] transition-all duration-200"
            />
          </div>
          <div className="flex items-end">
            <label className="flex items-center gap-2.5 cursor-pointer min-h-[44px]">
              ...
              />
              <span className="text-sm font-medium text-text">Union positions only</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="mb-5 flex items-center gap-2">
        ...
        {activeFilters > 0 && (
          <button
            ...
            className="text-xs text-periwinkle hover:text-periwinkle-dark font-medium transition-colors"
          >
            Clear filters
          </button>
        )}
